...
<body bgcolor="#FFCCFF">
    <br>
    <font size="6" color="green"><center><b><u><i>View and Update User Accounts</i></u></b></center></font> 
    ...
    <table bgcolor="#CC99FF" border="1" align="center" cellpadding="2" cellspacing="2">
        ...
        <h:form action="/cb">
            <tr>
                <td><h:radio property="check" value="checkbalance"/></td><td>CHECK BALANCE</td><br>
            </tr>
            <tr>
                <td><h:radio property="check" value="updatebalance"/></td><td>UPDATE BALANCE</td><br>
            </tr>
            <tr>
